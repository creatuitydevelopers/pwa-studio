    ...
    return (
        <React.Fragment>
            <div style={{height: '300px', position: 'relative'}}>
                <Map minZoom={3} style={{height: '300px'}} disableDefaultUI={true}
                     initialCenter={{lat: details.latitude, lng: details.longitude}}>
                    <Marker
                        shouldRender={true}
            ...
            <div className={classes.sticky}>
                <a href="#" className={classes.buttonSticky}><IoMdNavigate/></a>
                <a href={`tel:${details.phone}`} className={classes.buttonSticky}><IoIosCall/></a>
            </div>
            ...
            <div className={classes.content}>
                ...
                <h3 className={classes.detailsHeading}><strong>Address:</strong></h3>
                <p>{details.address}</p>
                <p>{details.city}, {details.state} {details.zipcode}</p>

                <h3 className={classes.detailsHeading}><strong>Contact Info:</strong></h3>
                <p><a href={`tel:${details.phone}`}>{details.phone}</a></p>
                <p><a href={`mailto:${details.email}`}>{details.email}</a></p>

                <h3 className={classes.detailsHeading}><strong>Other Info:</strong></h3>
                <p><strong>Opening Hours: </strong>{hours.open} - {hours.close}</p>
                <p><strong>Store Manager: </strong>{details.store_manager}</p>
